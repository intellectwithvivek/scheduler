      ...
      switch (event.EventType.toString()) {
        ...
        case "1": // recurrence Event
          ...
          if (recurrenceSeriesEdited) {
            ...
            // 1) adding prefix "Deleted" to event title
            // 2) Set RecurrenceID to event Date
            // 3) Set MasterSeriesItemID to event ID
            // 4)Set fRecurrence to true
            // 5) Set event type to 3
