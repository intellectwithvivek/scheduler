define([], function () {
  return {
    ...
    ConfirmeDeleteAllRecurrrencesMessage:
      "Confirm delete event ? If the event is a recurrence event all entries will be deleted ",
    ConfirmeDeleteOneRecurrenceMessage:
    ...
    EventPanelTitle1: "Event Details",
